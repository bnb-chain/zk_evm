...
fn pad_gen_inputs_with_dummy_inputs_if_needed(
    ...
    match gen_inputs.len() {
        ...
        1 => {
            ...
            let dummy_txn = create_dummy_gen_input(other_data, initial_extra_data, initial_tries);
...
fn process_txn_info(
    ...
    let delta_out = apply_deltas_to_trie_state(curr_block_tries, &txn_info.nodes_used_by_txn)?;
